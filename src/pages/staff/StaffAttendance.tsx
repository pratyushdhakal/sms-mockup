...
export default function StaffAttendance() {
  ...
  const records = attendanceRecords.filter((a) => a.userId === userId);
  ...
  return (
    <div>
      <Header title="My Attendance" subtitle="Attendance records" userName={currentStaff?.name || "Staff"} userRole="Staff" />
